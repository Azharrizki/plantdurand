                    ...
                    <div class="container m-auto" style="display: flex; justify-content: center;">
                        <div class="card" style="height: 17rem; width: 20rem;">
                            <div class="card-body ml-3 mr-3 c-daftar">
                                <h4 class="card-title text-lg-center mt-3 mb-4">Lupa kata sandi?</h4>
                                <h6 style="font-size: smaller; color:grey;" class="text-lg-center">masukan email yang sudah <br> pada website</h6>
                                <form action="/user/save" method="post">
                                    ...
                                    <!-- <button class="btn btn-gradient mt-4 mb-3" type="submit" style="width: 100%;">Kirim</button> -->
                                    <a href="/login/vertif" class="btn btn-gradient mt-4 mb-3" style="width: 100%;">Kirim</a>
                                </form>
                            </div>
                        </div>
                    </div>
